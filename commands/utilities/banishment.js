...
exports.data = new SlashCommandBuilder().setName('mahjongify').setDescription('Banishes a person to the mahjong dimension.').addUserOption(option => option.setName('user').setDescription('Enter the banishy').setRequired(true)).addStringOption(option => option.setName('toptext').setDescription('Enter the top text').setRequired(true)).addStringOption(option => option.setName('bottomtext').setDescription('Text that will appear on bottom').setRequired(false)).addStringOption(option => option.setName('outlinecolor').setDescription('Color that appears outside').setRequired(false)).addStringOption(option => option.setName('fillcolor').setDescription('Colour that appears inside').setRequired(false));
